        ...
        if ($('#id_unit').val() != '') {
            ...
            $.post(
				    ...
				    function (data) {
				        hasil = eval(data);
				        $("#id_system").html("");
				        $('<option value="">-- Pilih System --</option>').appendTo("#id_system");
				        for (var i = 0; i < hasil.length; i++) {
        ...
        if ($('#id_system').val() != '') {
            ...
            $.post(
				    ...
				    function (data) {
				        hasil = eval(data);
				        $("#id_equipment").html("");
				        $('<option value="">-- Pilih Equipment --</option>').appendTo("#id_equipment");
				        for (var i = 0; i < hasil.length; i++) {
        ...
        if ($('#id_equipment').val() != '') {
            ...
            $.post(
				    ...
				    function (data) {
				        ...
				        $('<option value="">-- Pilih Failure Mode --</option>').appendTo("#id_failure_mode");
    ...
    if (validate()) {
        ...
        $.post("Fracas/SaveEdit", values, function (data) {
            if (data == true) {
                ...
                $('#realmod_save').css("display", "none");
                alert('Data Tanggal yang diinputkan tidak valid');
            }
        });
    }
...
function validate() {
    if ($('#id_equipment').val() == '') {
        alert('Pilih equipment terlebih dahulu');
        return false;
    }

    if ($('#datetime_stop').val() == '') {
        alert('Date/Time Stop masih kosong');
        return false;
    }
